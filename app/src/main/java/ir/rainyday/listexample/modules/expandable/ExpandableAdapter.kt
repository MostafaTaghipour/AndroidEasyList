...
import ir.rainday.easylist.Expandable
...
class ExpandableAdapter(context: Context, layoutManager: LinearLayoutManager) : RecyclerViewAdapter<Any>(context), Expandable {
